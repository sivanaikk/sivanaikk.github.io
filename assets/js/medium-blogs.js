$(function () {
    ...
    var data = {
        rss: 'https://medium.com/feed/@sivanaikk0903'
    };
    $.get(' https://api.rss2json.com/v1/api.json?rss_url=https%3A%2F%2Fmedium.com%2Ffeed%2F%40sivanaikk0903', data, function (response) {
